...
<h2><center>welcome to search menu</center></h2>
    ...
    enter the department id for search<input type="text"  name="id">
...
try
{
  ...
  ResultSet rs = st.executeQuery("select * from department where D_id="+id+"");
  if(rs.next()){
      %>
      <center><h1>SEARCH RESULT</h1>
          <table BORDER="1"> <h3><br> <tr><td>department_id:</td><td><%out.println(id);%> </td></tr></h3>
          <h3><br> <tr><td>location_Name: </td><td><%=rs.getString("D_name")%> </td></tr></h3>
          </table>
          </center><%
  }
