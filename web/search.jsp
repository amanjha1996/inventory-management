...
<h2><center>welcome to search menu</center></h2>
    ...
    enter the city id for search<input type="text"  name="id">
...
try
{
  ...
  ResultSet rs = st.executeQuery("select * from city where city_id="+id+"");
  if(rs.next()){
      %>
      <center><h1>SEARCH RESULT</h1>
          <h3><br> <tr><td>city_Name: </td><td><%=rs.getString("city_name")%> </td></tr></h3>
          <h3><tr><td>city_status: </td><td><%=rs.getString("city_status")%> </td></tr></h3>
      </center><%
  }
