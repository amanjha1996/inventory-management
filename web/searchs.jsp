...
<h2><center>welcome to search menu</center></h2>
    ...
    enter the supplier id for search<input type="text"  name="id">
...
try
{
  ...
  ResultSet rs = st.executeQuery("select * from supplier where S_id="+id+"");
  if(rs.next()){
      %>
      <center><h1>SEARCH RESULT</h1>
          <table BORDER="1"> <h3><br> <tr><td>supplier_id:</td><td><%out.println(id);%> </td></tr></h3>
          <h3><br> <tr><td>supplier_Name: </td><td><%=rs.getString("S_name")%> </td></tr></h3>
          </table>
          </center><%
  }
