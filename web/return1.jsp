...
s1.executeUpdate("insert into tr values('"+tno+"','"+d+"','"+emp+"','"+dep+"','0','1')");      
s2.executeUpdate("insert into detail2 values('"+name+"','"+qty+"','"+location+"','"+tno+"')");
        %>
        <div>  <a href="returnadd.jsp?id=<%=tno%>"><b>want to add more items for an existing transaction</b></a></div>
        <br><br>
        <div> <a href="return.jsp">new transaction</a></div>
        <br><br>
        <div> <a href="returnreport.jsp">view report</a> </div>